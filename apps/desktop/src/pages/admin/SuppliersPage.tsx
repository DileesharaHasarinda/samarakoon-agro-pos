...
#suppliers-page::-webkit-scrollbar {
    width: 10px !important;
}

#suppliers-page::-webkit-scrollbar-track {
    background: #e8eeea !important;
    border-radius: 999px !important;
}

#suppliers-page::-webkit-scrollbar-thumb {
...
#suppliers-page::-webkit-scrollbar-thumb:hover {
    background:
...
#suppliers-page .sup-field-label {
    color: var(--sup-text-2) !important;
...
#suppliers-page .sup-list {
    ...
    background: var(--sup-page) !important;
}
