...
/**
 * Stores the clean amount in state.
 *
 * Examples:
 *
 * Display:
...
/**
 * Adds thousands separators only for display.
 *
 * 1250000.50
 * becomes
 * 1,250,000.50
...
#cheques-page .cp-header-actions {
    display:
        flex !important;
...
#cheques-page
.cp-summary-card.amber::before {
    background:
        var(--amber) !important;
}

#cheques-page
.cp-summary-card.red::before {
    background:
        var(--red) !important;
}
...
#cheques-page .cp-badge.cancelled {
    color:
        var(--muted) !important;
...
#cheques-page .cp-pagination-info {
    margin:
        0 !important;
...
#cheques-page .cp-pagination-actions {
    display:
        flex !important;
...
#cheque-form-modal,
#cheque-form-modal *,
#cheque-form-modal *::before,
#cheque-form-modal *::after {
    box-sizing:
...
#cheque-form-modal .cfm-field > span:first-child {
    color:
        #344054 !important;
...
#cheque-form-modal .cfm-amount-input-wrap {
    position:
        relative !important;
...
#cheque-form-modal .cfm-amount-prefix {
    position:
        absolute !important;
...
#cheque-form-modal .cfm-amount-preview {
    display:
        flex !important;
...
#cheque-form-modal .cfm-amount-preview-copy {
    display:
        flex !important;
...
#cheque-form-modal .cfm-amount-preview-label {
    color:
        #667085 !important;
...
#cheque-form-modal .cfm-amount-preview-value {
    color:
        #14532d !important;
...
#cheque-form-modal .cfm-amount-preview-help {
    flex:
        0 0 auto !important;
...
@media (
    ...
    #cheques-page .cp-header-actions .cp-btn {
        width:
            100% !important;
    }
...
export default function ChequesPage() {
    ...
    const handleSubmit =
        async (
            ...
            if (
                ...
                setFormError(
                    'Please enter a valid cheque amount greater than zero.',
                );
            ...
            try {
                /*
                 * formValues.amount remains clean:
                 *
                 * 1250000.50
                 *
                 * NOT:
                 ...
                 * 1,250,000.50
                 *
                 * Therefore the API receives a valid
                 * numeric value.
                 */
                const response =
                    editingCheque
    ...
    const rowClass = (
        ...
        dueSoonThreshold.setDate(
            dueSoonThreshold.getDate()
            + 3,
        );
        ...
        <div id="cheques-page">
            ...
            <header className="cp-header">
                <div>
                    ...
                    <p className="cp-subtitle">
                        Track cheques received from customers
                        and issued to suppliers.
                    </p>
                </div>
            ...
            <section className="cp-summary">
                <article className="cp-summary-card">
                    ...
                    <strong className="cp-summary-value">
                        {
                            summary
                                .total_cheques
                        }
                    ...
                    {isLoading ? (
                        ...
                        cheques.map(
                            (
                                ...
                                >
                                    <div>
                                        <strong className="cp-cell-title">
                                            {
                                                cheque
                                                    .cheque_number
                                            }
            ...
            {isFormOpen && (
                ...
                >
                    <section
                        ...
                        role="dialog"
                        aria-modal="true"
                        aria-labelledby="cheque-form-title"
                        onMouseDown={(
                            event,
                        ) => {
                    ...
                    >
                        <header
                            id="cheque-form-title"
                            className="cfm-header"
                        >
                            {editingCheque
                                ? 'Edit Cheque'
                                : 'Add Cheque'}
                            ...
                            <div className="cfm-body">
                                ...
                                <div className="cfm-grid">
                                    ...
                                    <label className="cfm-field">
                                        ...
                                        <div className="cfm-amount-input-wrap">
                                            <span className="cfm-amount-prefix">
                                                Rs.
                                            </span>
